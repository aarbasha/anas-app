            ...
            return (
              ...
              >
                <motion.div
                  ...
                  initial="hidden"
                  whileInView="visible"
                  className=" border-0 border-[#e8a230] hover:bg-blue-500/20 transition duration-300 bg-black/20 flex flex-col justify-center items-center gap-1 rounded-xl p-2"
                >
                  <IconComponent
                  ...
                  <div className="text-[11px] text-white overflow-hidden">
                    {item.name}
                  </div>
                </motion.div>
              </Tilt>
